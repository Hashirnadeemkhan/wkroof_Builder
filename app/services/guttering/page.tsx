  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: "linear-gradient(to right, rgba(10,20,35,0.92) 0%, rgba(10,20,35,0.60) 100%), url('/guttering-roof-768x510.jpeg')",
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="shrink-0 w-full max-w-xl">
            <div className="rounded-2xl overflow-hidden relative" style={{ height: "420px", boxShadow: "0 25px 60px rgba(0,0,0,0.5)" }}>
              <Image src="/guttering-roof-768x510.jpeg" alt="Guttering" fill className="object-cover object-top" sizes="600px" />
      ...
      <section className="py-16 px-6 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold" style={{ color: "#1B2A41" }}>Guttering Projects We&apos;re Proud Of</h2>
          </div>
          <div className="grid sm:grid-cols-2 gap-5">
            <div className="relative rounded-2xl overflow-hidden" style={{ height: "320px" }}>
              <Image src="/guttering-roof-768x510.jpeg" alt="Guttering installation" fill className="object-cover object-top" sizes="(max-width: 640px) 100vw, 50vw" />
            </div>
            <div className="relative rounded-2xl overflow-hidden" style={{ height: "320px" }}>
              <Image src="/WhatsApp%20Image%202026-05-19%20at%207.56.14%20PM.jpeg" alt="Guttering repair work" fill className="object-cover object-center" sizes="(max-width: 640px) 100vw, 50vw" />
            </div>
          </div>
        </div>
      </section>
